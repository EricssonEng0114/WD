<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Admin.Master" AutoEventWireup="true" CodeBehind="ViewRLHistory.aspx.cs" Inherits="UBPCWeb.Modules.ActionedItemHistory.ViewRLHistory" %>
                                                                            ...
                                                                            <table>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="width: 70%">
                                                                                        ...
                                                                                        <asp:TextBox ID="txtBottomBSB" runat="server" CssClass="form-control" Style="text-align: left" MaxLength="20"  ReadOnly="True">xxxxxxxxxxxxxxxxxxxx</asp:TextBox></td>
                                                                                    <td style="width: 25%; padding-left: 20px">Cheque Amount:
                                                                                        <asp:TextBox ID="txtBottomAmount" runat="server" CssClass="form-control" Style="text-align: right" ReadOnly="True">0.00</asp:TextBox></td>
                                                                                </tr>
                                                                            </table>
                                                                        </div>
                                                                        ...
                                                                        <div style="width: 100%">
                                                                            ...
                                                                            <div style="width: 100%; float: left">
                                                                                <asp:ListBox ID="LstBSelectItem" runat="server" CssClass="form-control"
                                                                                    Font-Names="Lucida Console,Courier New" Font-Bold="true" Rows="25" Style="font-size: 17px; width: 90%; border: 1px solid groove" AutoPostBack="true" OnSelectedIndexChanged="LstBSelectItem_SelectedIndexChanged">
                                                                                </asp:ListBox>
                                                                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#topImgToggle").off('click').on('click', function () {
            toggleImage("ARL", "TOP", "#RLImgViewerTop");
        });

        $("#topImgFlip").off('click').on('click', function () {
            flipImage("ARL", "TOP", "#RLImgViewerTop");
        });

        $("#bottomImgToggle").off('click').on('click', function () {
            toggleImage("ARL", "BOT", "#RLImgViewerBottom");
        });

        $("#bottomImgFlip").off('click').on('click', function () {
            flipImage("ARL", "BOT", "#RLImgViewerBottom");
        });
        ...
        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(
          function () {
              ...
              $("#topImgToggle").click(function () {
                  toggleImage("ARL", "TOP", "#RLImgViewerTop");
              });

              $("#topImgFlip").click(function () {
                  flipImage("ARL", "TOP", "#RLImgViewerTop");
              });

              $("#bottomImgToggle").click(function () {
                  toggleImage("ARL", "BOTTOM", "#RLImgViewerBottom");
              });

              $("#bottomImgFlip").click(function () {
                  flipImage("ARL", "BOTTOM", "#RLImgViewerBottom");
              });
          }
        );
    });
