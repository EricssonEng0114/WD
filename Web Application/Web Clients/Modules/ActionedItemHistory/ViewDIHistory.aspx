<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Admin.Master" AutoEventWireup="true" CodeBehind="ViewDIHistory.aspx.cs" Inherits="UBPCWeb.Modules.ActionedItemHistory.ViewDIHistory" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#topImgToggle").off('click').on('click', function () {
            toggleImage("ADI", "TOP", "#DIImgViewerTop");
        });

        $("#topImgFlip").off('click').on('click', function () {
            flipImage("ADI", "TOP", "#DIImgViewerTop");
        });

        $("#bottomImgToggle").off('click').on('click', function () {
            toggleImage("ADI", "BOT", "#DIImgViewerBottom");
        });

        $("#bottomImgFlip").off('click').on('click', function () {
            flipImage("ADI", "BOT", "#DIImgViewerBottom");
        });
