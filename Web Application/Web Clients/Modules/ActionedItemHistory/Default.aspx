<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Admin.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="UBPCWeb.Modules.ActionedItemHistory.Default" %>
    ...
    <form runat="server">
        <div class="content">
            <ul class="breadcrumb">
                ...
                <li><a href="/History" class="active">Actioned Item History</a></li>
            </ul>
            <div class="page-title">
                <i class="icon-custom-right"></i>
                <h3><span class="semi-bold">Actioned Item History - List</span></h3>
            </div>
            <div class="row-fluid">
                <div class="span12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlClient" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlClient_SelectedIndexChanged1">
                                        </asp:DropDownList>
                                    </div>
                                </div>
