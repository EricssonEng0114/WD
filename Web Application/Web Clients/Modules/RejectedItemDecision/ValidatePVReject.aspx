<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Admin.Master" AutoEventWireup="true" CodeBehind="ValidatePVReject.aspx.cs" Inherits="UBPCWeb.Modules.RejectedItemDecision.ValidatePVReject" %>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $("#topImgToggle").off('click').on('click', function () {
                    toggleImage("PV", "TOP", "#PVImgViewerTop");
                });

                $("#topImgFlip").off('click').on('click', function () {
                    flipImage("PV", "TOP", "#PVImgViewerTop");
                });

                $("#bottomImgToggle").off('click').on('click', function () {
                    toggleImage("PV", "BOT", "#PVImgViewerBottom");
                });

                $("#bottomImgFlip").off('click').on('click', function () {
                    flipImage("PV", "BOT", "#PVImgViewerBottom");
                });
