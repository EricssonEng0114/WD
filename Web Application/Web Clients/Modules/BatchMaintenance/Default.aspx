<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Admin.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="UBPCWeb.Modules.BatchMaintenance.Default" %>
    ...
    <form runat="server">
        <div class="content">
            <ul class="breadcrumb">
                ...
                <li><a href="/Batch" class="active">Batch Maintenance</a></li>
            </ul>
            <div class="page-title">
                <i class="icon-custom-right"></i>
                <h3><span class="semi-bold">Batch Maintenance - List</span></h3>
            </div>
            <div class="row-fluid">
                <div class="span12">
                    <div class="grid simple">
                        ...
                        <div class="grid-body ">
                            <div>
                                <p>
                                    <asp:Label ID="lblCutOffTimeMsg" runat="server" Text="*Sorry, you cannot perform reset after Cut Off time." Visible="False" Font-Bold="True" Font-Size="Medium" ForeColor="Red"></asp:Label></p>
                            </div>
       ...
       <%--         $("#<%: txtDateTime.ClientID %>").datepicker(
        ...
        <script>
            ...
            {
                return confirm("Transaction Is In-Use. Are you sure to proceed?");
